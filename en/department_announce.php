		...
		<div id="announce" class="content_box">
			...
			<?php 
				...
				if (count($xml)==0 || $xml = null)
					...
					if ($page>1)
						echo '<a style="text-decoration:none; color:#222B00;" href="?page='.($page-1).'" >Newer Announcements</a>';
					...
					if ($page<$total_pages)	
						echo '<a style="text-decoration:none; color:#222B00;" href="?page='.($page+1).'" >Older Announcements</a>';
