...
(function (l, t, k) {
        ...
        a.widget.bridge = function (b, g) {
            a.fn[b] = function (d) {
                ...
                j ? this.each(function () {
                    ...
                    var c = a.data(this, b);
                    c ? c.option(d || {})._init() : a.data(this, b, new g(d, this))
                });
                return q
            }
        };
    ...
    (function (a, c) {
        ...
        function d(a, b, c) {
            ...
            for (i = 0; i < c.length; i++) {
                var h = c[i],
                    j = "-" + h.charAt(0).toLowerCase() + h.substr(1) + "-" + a + ": " + b + ";",
    ...
    (function (a, c, b) {
            ...
            setup: function () {
                ...
                c.bind(g, function (d) {
                    ...
                    c.bind(j, e).one(f, function () {
                        c.unbind(j, e);
                        k && n && n.time - k.time < a.event.special.swipe.durationThreshold && Math.abs(k.coords[0] - n.coords[0]) > a.event.special.swipe.horizontalDistanceThreshold && Math.abs(k.coords[1] - n.coords[1]) < a.event.special.swipe.verticalDistanceThreshold && k.origin.trigger("swipe").trigger(k.coords[0] > n.coords[0] ? "swipeleft" : "swiperight");
                        k = n = b
                    })
                })
            }
        ...
        (function (a, b) {
            ...
            if (a.support.orientation && (j = b.innerWidth || a(b).width(), g = b.innerHeight || a(b).height(), j = j > g && j - g > 50, g = l[b.orientation], j && g || !j && !g)) l = {
                "-90": true,
                90: true
            };
    ...
    (function (a, c) {
        function b(b) {
            l && (!l.closest(".ui-page-active").length || b) && l.removeClass(a.mobile.activeBtnClass);
            l = null
        }
        function d() {
            p = false;
            ...
            m = {
                ...
                makeUrlAbsolute: function (a, b) {
                    ...
                    var c = m.parseUrl(a),
                        ...
                        j = c.pathname !== "",
                        g = m.makePathAbsolute(c.pathname || d.filename, d.pathname);
        ...
        q.bind(a.support.pushState ? "popstate" : "hashchange", function () {
            C = false
        });
        ...
        a.mobile.loadPage = function (b, d) {
            ...
            if (g.length === 0) if (a.mobile.firstPage && m.isFirstPageUrl(n)) a.mobile.firstPage.parent().length && (g = a(a.mobile.firstPage));
        ...
        a.mobile.changePage = function (j, g) {
        ...
        a.mobile.navreadyDeferred.done(function () {
                ...
                if (a.mobile.linkBindingEnabled) {
                    ...
                    if (e && !(d.which > 1) && f.jqmHijackable().length) {
                        ...
                        if (!a.mobile.ajaxEnabled && !m.isEmbeddedPage(e)) g();
                            ...
                            if (e.search("#") != -1) if (e = e.replace(/[^#]*#/, "")) e = m.isPath(e) ? m.makeUrlAbsolute(e, k) : m.makeUrlAbsolute("#" + e, x.hrefNoHash);
                            else {
                                d.preventDefault();
                                return
                            }
            ...
            a.mobile._handleHashChange = function (b) {
                ...
                if (!a.mobile.hashListeningEnabled || n.ignoreNextHashChange) n.ignoreNextHashChange = false;
                    ...
                    if (n.stack.length > 1 && d.indexOf(s) > -1 && n.initialDst !== d) if (a.mobile.activePage.is(".ui-dialog")) n.directHashChange({
                        currentUrl: d,
                        either: function (b) {
    ...
    (function (a, c) {
        ...
        a.extend(b, {
            ...
            onPopState: function (c) {
                if (c = c.originalEvent.state) clearTimeout(b.hashChangeEnableTimer), b.nextHashChangePrevented(false), a.mobile._handleHashChange(c.hash), b.nextHashChangePrevented(true), b.hashChangeEnableTimer = setTimeout(function () {
            ...
            if (b) d = b.options, a(c.target).find("input").not(b.keepNativeSelector()).each(function () {
                ...
                if (d.degradeInputs[c]) {
                    var j = a("<div>").html(b.clone()).html(),
                        h = j.indexOf(" type=") > -1;
                    b.replaceWith(j.replace(h ? /\s+type=["']?\w+['"]?/ : /\/?>/, ' type="' + f + '" data-' + a.mobile.ns + 'type="' + c + '"' + (h ? "" : ">")))
                }
            })
        })
    })(l);
    ...
    (function (a) {
        a.fn.grid = function (c) {
            return this.each(function () {
                ...
                if (!d) if (e.length <= 5) for (var f in g) g[f] === e.length && (d = f);
    ...
    (function (a, c) {
        ...
        a.fn.buttonMarkup = function (b) {
            for (var b = b && a.type(b) == "object" ? b : {}, g = 0; g < this.length; g++) {
                ...
                (p = a.data(j.tagName === "INPUT" || j.tagName === "BUTTON" ? j.parentNode : j, "buttonElements")) ? (j = p.outer, f = a(j), l = p.inner, n = p.text, a(p.icon).remove(), p.icon = null) : (l = k.createElement(h.wrapperEls), n = k.createElement(h.wrapperEls));
                ...
                p || l.appendChild(n);
                if (r && (r.className = m, !p || !p.icon)) r.appendChild(k.createTextNode("\u00a0")), l.appendChild(r);
        ...
        var d = function () {
            ...
            a(k).bind({
                "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart": function (d) {
                    ...
                    }, c) : k.removeClass("ui-btn-up-" + h).addClass("ui-btn-hover-" + h);
    ...
    (function (a) {
        a.widget("mobile.collapsible", a.mobile.widget, {
            ...
            _create: function () {
                ...
                g.addClass(b.contentTheme ? "ui-body-" + b.contentTheme : "");
            ...
            _createSubPages: function () {
                ...
                a(b.find("li>ul, li>ol").toArray().reverse()).each(function (c) {
                    var d = a(this),
                        ...
                        x = d.jqmData("counttheme") || b.jqmData("counttheme") || j.countTheme;
                    m = true;
        ...
        a.widget("mobile.button", a.mobile.widget, {
            ...
            _create: function () {
                ...
                if (b[0].tagName === "A")!b.hasClass("ui-btn") && b.buttonMarkup();
                    ...
                    if (!this.options.theme) this.options.theme = a.mobile.getInheritedTheme(this.element, "c");~b[0].className.indexOf("ui-btn-left") && (g = "ui-btn-left");~b[0].className.indexOf("ui-btn-right") && (g = "ui-btn-right");
                    if (b.attr("type") === "submit" || b.attr("type") === "reset") g ? g += " ui-submit" : g = "ui-submit";
                    a("label[for='" + b.attr("id") + "']").addClass("ui-submit");
                    d = this.button = a("<div></div>").text(b.text() || b.val()).insertBefore(b).buttonMarkup({
                        theme: e.theme,
                        icon: e.icon,
                        iconpos: e.iconpos,
                        inline: e.inline,
    ...
    (function (a) {
        a.widget("mobile.textinput", a.mobile.widget, {
            ...
            _create: function () {
                ...
                c.is("[type='search'],:jqmData(type='search')") ? (j = c.wrap("<div class='ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield" + e + f + "'></div>").parent(), h = a("<a href='#' class='ui-input-clear' title='" + b.clearSearchButtonText + "'>" + b.clearSearchButtonText + "</a>").bind("click", function (a) {
                ...
                }, d(), c.bind("paste cut keyup focus change blur", d)) : c.addClass("ui-corner-all ui-shadow-inset" + e + f);
                c.focus(function () {
    ...
    (function (a) {
        a.widget("mobile.selectmenu", a.mobile.widget, {
            ...
            _preExtension: function () {
                var c = "";~this.element[0].className.indexOf("ui-btn-left") && (c = " ui-btn-left");~this.element[0].className.indexOf("ui-btn-right") && (c = " ui-btn-right");
            ...
            _create: function () {
                ...
                b.nativeMenu && t.opera && t.opera.version && d.addClass("ui-select-nativeonly");
    ...
    (function (a) {
        var c = function (b) {
            ...
            b.isMultiple && (s = a("<a>", {
                ...
                href: "#",
                "class": "ui-btn-left"
            }).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(r).buttonMarkup());
            a.extend(b, {
                select: b.select,
                selectID: c,
                buttonId: l,
                ...
                close: function () {
                    if (!this.options.disabled && this.isOpen) this.menuType == "page" ? t.history.back() : (this.screen.addClass("ui-screen-hidden"), this.listbox.addClass("ui-selectmenu-hidden").removeAttr("style").removeClass("in"), this.list.appendTo(this.listbox), this._focusButton()), this.isOpen = false
                },
                open: function () {
                    function c() {
                    ...
                    if (!this.options.disabled) {
                        ...
                        if (h > l - 80 || !a.support.scrollTop) {
                            ...
                            f < p ? g = (e - f) / 2 : (g = d.button.offset().left + d.button.outerWidth() / 2 - f / 2, g < 30 ? g = 30 : g + f > e && (g = e - f - 30));
                ...
                _buildList: function () {
                    ...
                    q = false, p, t = 0; t < h; t++, q = false) {
                        ...
                        if (d && (!s.getAttribute("value") || E.length == 0 || r.jqmData("placeholder"))) if (d = false, q = true, s.setAttribute(j, true), b.hidePlaceholderMenuItems && L.push("ui-selectmenu-placeholder"), !c) c = this.placeholder = E;
            ...
            options: {
                ...
                supportBlacklist: function () {
                    var a = navigator.userAgent,
                        ...
                        f = !! g && g[1];
                    return (b.indexOf("iPhone") > -1 || b.indexOf("iPad") > -1 || b.indexOf("iPod") > -1) && d && d < 534 || t.operamini && {}.toString.call(t.operamini) === "[object OperaMini]" || g && f < 7458 || a.indexOf("Android") > -1 && d && d < 533 || e && e < 6 || "palmGetResource" in t && d && d < 534 || a.indexOf("MeeGo") > -1 && a.indexOf("NokiaBrowser/8.5.0") > -1 ? true : false
                },
            ...
            a.extend(a.mobile, {
                showPageLoadingMsg: function (b, c, e) {
                    ...
                    if (a.mobile.loadingMessage) {
                        ...
                        j.attr("class", "ui-loader ui-corner-all ui-body-" + (b || "a") + " ui-loader-" + (k ? "verbose" : "default") + (e ? " ui-loader-textonly" : "")).find("h1").text(c || a.mobile.loadingMessage).end().appendTo(a.mobile.pageContainer);
                        d();
                        f.bind("scroll", d)
                    }
                },
                ...
                initializePage: function () {
                    ...
                    a.mobile.showPageLoadingMsg();
                    e();
                    !a.mobile.hashListeningEnabled || !a.mobile.path.isHashValid(location.hash) || !a(location.hash + ':jqmData(role="page")').length && !a.mobile.path.isPath(location.hash) ? a.mobile.changePage(a.mobile.firstPage, {
                        transition: "none",
                        reverse: true,
                        changeHash: false,
                        fromHashChange: true
