	...
	<div id="content">
		<div id="contact" class="content_box">
			...
			<table style="margin: 25px;">
				<tr>
					<td >
								<object id="map" type="text/html" data="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=%CE%9B%CE%AC%CF%81%CE%B9%CF%83%CE%B1(Τμήμα Ζωικής Παραγωγής)@39.62502,22.379129&amp;spn=0.004438,0.009559&amp;output=embed" style="width:400px;height:400px;">
								</object>
									...
									('src',o.getAttribute('data'));i.setAttribute('frameBorder','0');i.style.width=o.style.width;i.style.height=o.style.
					...
					<td >
							<p style="text-align:left; margin-left: 25px;">
								...
								FAX: 2410 684320 <br />
								Email: <a style="text-decoration:none; color:#B37400;" href="mailto:mitroo@teilar.gr">mitroo@teilar.gr</a> <br /> <br />
							</p>
					</td>	
				</tr>
			</table>
